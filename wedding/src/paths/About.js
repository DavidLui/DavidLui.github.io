        ...
        <div className="row-about">
            <div className="about ">
                <div className="column-about left">
                    ...
                    {/* <div className="credits">Photography: L.C. Allison Photography</div> */}
                </div>
                <div className="column-about right">
                    <p>
                        <span className='gar'>Hey, I’m Jamie</span> and I’m here to be your bridal (or event!) bestie.
